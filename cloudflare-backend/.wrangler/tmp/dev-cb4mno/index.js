...
// .wrangler/tmp/bundle-Z4GqUX/strip-cf-connecting-ip-header.js
...
var src_default = {
  async fetch(request, env2) {
    ...
    if (url.pathname === "/ws/dashboard") {
      return handleWebSocketConnection(request, env2);
    }
...
async function handleWebSocketConnection(request, env2) {
  const url = new URL(request.url);
...
// .wrangler/tmp/bundle-Z4GqUX/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Z4GqUX/middleware-loader.entry.ts
